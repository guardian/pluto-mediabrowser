...
describe("DropdownField", ()=>{
    it("should render a select with a set of options according to the menuhints", ()=>{
        ...
        const rendered = shallow(<DropdownField fieldname="test-field"
                                              viewHints={viewHints}
        ...
        expect(rendered.childAt(1).text()).toEqual("(not set)First valueSecond valueThird valueFourth value");
    })
})